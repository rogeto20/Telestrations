var Play = (function () {
    ...
    var canvas,
        ...
        init = function () {
            ...
            crayonImage.src = "/Content/Images/Play/crayon-outline.png";

            markerImage.onload = resourceLoaded;
            markerImage.src = "/Content/Images/Play/marker-outline.png";

            eraserImage.onload = resourceLoaded;
            eraserImage.src = "/Content/Images/Play/eraser-outline.png";

            crayonBackgroundImage.onload = resourceLoaded;
            crayonBackgroundImage.src = "/Content/Images/Play/crayon-background.png";

            markerBackgroundImage.onload = resourceLoaded;
            markerBackgroundImage.src = "/Content/Images/Play/marker-background.png";

            eraserBackgroundImage.onload = resourceLoaded;
            eraserBackgroundImage.src = "/Content/Images/Play/eraser-background.png";

            crayonTextureImage.onload = resourceLoaded;
            crayonTextureImage.src = "/Content/Images/Play/crayon-texture.png";

            outlineImage.onload = resourceLoaded;
            outlineImage.src = "/Content/Images/Play/blank.png";
        };
